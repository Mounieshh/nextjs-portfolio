...
const AboutPage = () => {
    ...
    <>
      <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0vh" }} transition={{ duration: 1 }}>
        ...
        <div className='h-full overflow-scroll lg:flex' ref={containerRef}>
          {/* TEXT CONTAINER */}
          <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-12 md:gap-24 lg:gap-48 xl:gap-64 
          lg:w-1/2 lg:pr-0 xl:w-1/2'>
            {/* ABOUT ME SECTION */}
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              ...
              <div className='flex gap-2 sm:gap-4 flex-wrap md:gap-4'>
                ...
                <div className="rounded p-2 text-xs sm:text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">React.js</div>
                <div className="rounded p-2 text-xs sm:text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">Redux</div>
                <div className="rounded p-2 text-xs sm:text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">Node.js</div>
                <div className="rounded p-2 text-xs sm:text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">JWT</div>
                <div className="rounded p-2 text-xs sm:text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black">Express.js</div>
  ...
  <div className=''>
    ...
    <div className='flex justify-between h-48'>
      {/* LEFT */}
      <div className='w-1/3 md:w-2/5 lg:w-1/3'>
        <div className='bg-white p-3 font-semibold rounded-b-lg rounded-s-lg'>FULL STACK WEB DEV</div>
        <div className='p-3 text-sm italic'>
          As an Intern I learned and experienced new things about web dev
        </div>
      ...
      {/* CENTER */}
      <div className='w-1/6 md:w-1/12 lg:w-1/6'>
      ...
      {/* RIGHT */}
      <div className='w-1/3 md:w-2/5 lg:w-1/3'></div>
    </div>
    <div className='flex justify-between h-48'>
      {/* LEFT */}
      <div className='w-1/3 md:w-2/5 lg:w-1/3'></div>
