...
const links = [
  ...
  { url: "/portfolio", title: "Por tfolio" },
    ...
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-lg">
        ...
        <div className="md:hidden">
          <button className="w-10 h-10 flex flex-col justify-between z-50 relative" onClick={() => setOpen((prev) => !prev)}>
            ...
            <motion.div variants={bottomVariants} animate={open ? "opened" : "closed"} className="w-10 h-1 bg-black rounded origin-top-left"></motion.div>
          </button>
